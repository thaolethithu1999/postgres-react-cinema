...
export const MyItemForm = () => {
  ...
  return (
    <div className="view-container">
      {!window.location.pathname.includes('upload') ? <form
        id="itemForm"
        name="itemForm"
        model-name="item"
        ref={refForm as any}
      >
        <header>
          ...
          {(!isUpload && !flag.newMode)&& <button className='btn-group btn-left'><i onClick={e => navigate('upload')} className='material-icons'>photo</i></button>}
        </header>
